...
def install_python_dependencies():
    ...
    if not run_command(f"{pip_cmd} install -r code/requirements.txt", "Installing Python packages"):
        return False
...
def setup_database():
    ...
    try:
        ...
        from code.utils.database import DatabaseManager
...
def main():
    ...
    if failed_steps:
        ...
        print("   2. Review code/config.py for trading parameters")
